...
from funcoes_2024 import calcular_aluno_equivalente
from funcoes_2024 import criar_ciclos_simulacao
from funcoes_2024 import calcular_matriculas_totais_ano
...
with tab_simulacao:
    ...
    ANOS_SIMULACAO = st.slider("Selecione os anos para simular ciclos", 2024, 2045, (2027, 2035))
    ...
    if uploaded_file is not None:
        ...
        ano_filtrar = int(st.number_input("Ano de referência", value=int(2027), min_value=2022, max_value=2040))
        valor_MT = int(st.number_input("Valor médio por MT (é um valor estimado)", value=1100.00, min_value=800.00, max_value=2000.00))
